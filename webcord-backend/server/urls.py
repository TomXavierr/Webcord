...
urlpatterns = [
    ...
    # path('channels/create/', ChannelCreateAPIView.as_view(), name='channel-create'),
    # path('channels/update/<int:pk>/', ChannelUpdateAPIView.as_view(), name='channel-update'),
    # path('channels/delete/<int:pk>/', ChannelDeleteAPIView.as_view(), name='channel-delete'),
